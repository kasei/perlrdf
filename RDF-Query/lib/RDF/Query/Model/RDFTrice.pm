...
no warnings 'once';
*RDF::Query::Model::RDFTrine::is_node		= \&isa_node;
*RDF::Query::Model::RDFTrine::is_resource	= \&isa_resource;
*RDF::Query::Model::RDFTrine::is_literal		= \&isa_literal;
*RDF::Query::Model::RDFTrine::is_blank		= \&isa_blank;
