# RDF::Query::Algebra::OptPlus
# -----------------------------------------------------------------------------

=head1 NAME

RDF::Query::Algebra::OptPlus - Algebra class for OPT+ patterns

=head1 VERSION

This document describes RDF::Query::Algebra::OptPlus version 2.914.

=cut

package RDF::Query::Algebra::OptPlus;
...
sub new {
	...
	my $pattern	= shift;
	my $opt		= shift;
	return bless( [ 'OPTPLUS', $pattern, $opt ], $class );
}
