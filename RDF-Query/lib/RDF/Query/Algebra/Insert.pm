# RDF::Query::Algebra::Insert
# -----------------------------------------------------------------------------

=head1 NAME

RDF::Query::Algebra::Insert - Algebra class for INSERT operations

=head1 VERSION

This document describes RDF::Query::Algebra::Insert version 2.202, released 30 January 2010.

=cut

package RDF::Query::Algebra::Insert;
...
Returns a new INSERT structure.
