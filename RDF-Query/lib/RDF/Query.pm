...
This document describes RDF::Query version 2.902_01.
...
lead to a stable 3.000 release supporting SPARQL 1.1. Version 2.902_01 introduces
the SPARQL 1.1 features up to date with the SPARQL 1.1 working drafts as of its
release date. Version 2.902_01 also is the first version to require use of
