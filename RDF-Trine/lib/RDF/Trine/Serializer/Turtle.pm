...
This document describes RDF::Trine::Serializer::Turtle version 1.007
...
sub _node_concise_string {
	...
	if ($obj->is_literal and $obj->has_datatype) {
		...
		if ($dt =~ m<^http://www.w3.org/2001/XMLSchema#(integer|double|decimal)$> and $obj->can('is_valid_lexical_form') and $obj->is_valid_lexical_form) {
