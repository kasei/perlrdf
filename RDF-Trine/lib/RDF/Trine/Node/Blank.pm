...
This document describes RDF::Trine::Node::Blank version 1.001
...
sub new {
	...
	if ($name =~ m/[^A-Za-z0-9]/) {
		throw RDF::Trine::Error::SerializationError
            -text => "Only alphanumerics are allowed in N-Triples bnode labels (you supplied $name)";
	}
