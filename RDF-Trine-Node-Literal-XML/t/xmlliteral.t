...

{
	...
	my $l	= RDF::Trine::Node::Literal::XML->new_from_node( $el );
	isa_ok( $l, 'RDF::Trine::Node::Literal::XML' );
...
throws_ok {
	...
	my $l	= RDF::Trine::Node::Literal::XML->new_from_node( $text );
} 'RDF::Trine::Error', 'throws on text node';

lives_ok { 
  my $parser = XML::LibXML->new();
  my $doc = $parser->parse_string( '<bar>baz</bar>');
  my $l	= RDF::Trine::Node::Literal::XML->new_from_node( $doc );
...
lives_ok { 
  ...
  my $l	= RDF::Trine::Node::Literal::XML->new_from_node( $node );
...
lives_ok { 
  ...
  my $l	= RDF::Trine::Node::Literal::XML->new_from_node( $nodes );
} 'lives on nodelist';
