...
RDF::Trice::Node::Literal - RDF Node class for literals

=cut

package RDF::Trice::Node::Literal;
...
sub new {
	...
	throw RDF::Trice::Error::MethodInvocationError ( -text => "Literal values cannot have both language and datatype" ) if ($lang and $dt);
	if ($lang) {
